...
func init() {
	...
	createFuncCmd.Flags().StringVarP(&createFuncInput.instanceType, "instance-type", "", "e1", "Instance Type, such as e1, c1, g1")
...
var createFuncCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		input := fc.NewCreateFunctionInput(createFuncInput.serviceName).
			...
			WithGpuMemorySize(createFuncInput.gpuMemory).
